...
define ('unit_freq',12);
define ('race_changes',2);
define ('deposit_rate',0.80);
define ('deposit_interval', 500);
...
define ('injured_atk', 0);
define ('injured_def', 0);
define ('injured_income', 0);
