...
if (isset($_SESSION['userid'])){
	...
	if (isset($_POST['upgrade-siege']))
	{
		...
		if ($gold >= $costo and $siege < $GLOBALS['max_siege']){
			...
			echo "<div class='no-gold'>You don't have enough gold for that</div>";
		}
	}
	...
	$next_repli = ($replication+1<=$GLOBALS['max_repli']) ? $tech_replication[$replication+1]." Units every ".unit_freq." hours" : "No more upgrades";
	...
	<tr class='impar'>
	<th>Current Fortification</th><th>Upgrade</th><th>Next Fortification</th>
	</tr>
	<tr class='par'>
	...
	<tr class='par'> 
	<td>".$tech_replication[$replication]." Units every ".unit_freq." hours</td><td>".$next_repli_button."</td><td>".$next_repli."</td>
	<tr/>
	</table>
	</form>";
